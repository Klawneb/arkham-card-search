...
import { Faction, FactionColors } from "../../types/api.d";
        ...
        <div className="flex flex-col p-2">
            <div className="grid grid-cols-3 grid-rows-2 gap-2">
                <Chip.Group
                    ...
                    onChange={(value) =>
                        filterStore.setFactionFilter(value as Faction[])
                    }
                >
                            ...
                            <Chip
                                ...
                                styles={{
                                    ...
                                    label: {
                                        ...
                                        backgroundColor:
                                            filterStore.factionFilter.includes(
                                                faction as Faction
                                            )
                                                ? color
